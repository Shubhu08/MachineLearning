...
class linear_layer:
    ...
    def __init__(self, input_D, output_D):
        ...
        b_shape = (1, output_D)
        self.params['W'] = np.random.normal(0,0.1, W_shape)
        self.params['b'] = np.random.normal(0,0.1, b_shape)
        ...
        self.gradient['W'] = np.zeros(W_shape)
        self.gradient['b'] = np.zeros(b_shape)
    ...
    def backward(self, X, grad):
        ...
        self.gradient['W'] = np.multiply(X.T, grad)
        ...
        if hasattr(module, 'params'):
            for key, _ in module.params.items():
                ...
                if _alpha <= 0.0:
                    ...
                    module.params[key] = module.params[key] - (g * _learning_rate)
                    ...
                    momentum[str(module_name + '_' + key)] = _alpha * momentum[str(module_name + '_' + key)] - (g * _learning_rate)
                    module.params[key] = module.params[key] + momentum[str(module_name + '_' + key)]
